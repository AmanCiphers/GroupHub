...
const team = [
  ["Aman", "Founder & Developer", "Building GroupHub from the ground up — product direction, design, frontend, backend, and deployment.", "https://aman.thecloverforge.com"],
  ["Brijesh Sharma", "Frontend Collaborator", "Frontend collaborator focused on clean, responsive interfaces with attention to design detail and user experience.", "https://github.com/Brijesh-Sharma2004"],
]
          ...
          <div className="border border-[#d9d8d2] bg-[#fbfbfa] p-7">
            ...
            <div className="mt-5 space-y-5 text-lg font-semibold leading-relaxed text-[#4a4945]">
              ...
              <p className="text-sm text-[#77766f]">
                GroupHub is a product by <Link href="https://thecloverforge.com" target="_blank" rel="noopener noreferrer" className="underline underline-offset-4">CloverForge</Link>.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {team.map(([name, role, bio, url]) => (
            <div key={name} className="border border-[#d9d8d2] bg-[#fbfbfa] p-5">
              ...
              <Link href={url} target="_blank" rel="noopener noreferrer" className="mt-3 inline-flex items-center gap-1 text-sm font-black underline underline-offset-4">
                {url.replace("https://", "")}
